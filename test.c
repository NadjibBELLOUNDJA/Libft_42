...
/*   Updated: 2014/11/19 18:05:52 by nbelloun         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	test_memcpy(void)
{
	...
	test[3] = memcmp(memcpy(str2, str1, n + 1), ft_memcpy(str3, str1, n + 1), n + 1);
	str1[n - 1] = '\0';
	str1[n] = 'z';
	test[4] = memcmp(memcpy(str2, str1, n + 1), ft_memcpy(str3, str1, n + 1), n - 1);
	free(str2);
	free(str3);
	print_test_results(test, ctrl, 5, NULL);
}
