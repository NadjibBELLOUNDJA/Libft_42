...
SOURCE = ft_memset.c ft_memset.c ft_bzero.c ft_memcpy.c ft_memccpy.c \
		...
		ft_strsub.c ft_strjoin.c ft_putstr_fd.c ft_putendl_fd.c \
		ft_putnbr_fd.c ft_lstnew.c ft_lstdelone.c ft_lstdel.c ft_lstadd.c \
		ft_strjoin.c ft_strtrim.c ft_strsplit.c ft_itoa.c ft_putchar.c \
		ft_putchar_fd.c ft_putendl.c ft_putnbr.c ft_putstr.c ft_lstiter.c \
		ft_lstmap.c ft_strrev.c ft_isblank.c\
